...
\end{math}
	...
	\begin{frame}[fragile]
		...
		\begin{lstlisting}
			this?
		\end{lstlisting}\pause
		Sometimes, you want to print certain characters and words \textit{as} they are without any of \LaTeX{}'s formatting. \pause To do that \textit{inline}, use the {\verb|\verb|}$||$ command (note the vertical bars we use instead of curly braces here; use math mode to type in the bars).\pause
